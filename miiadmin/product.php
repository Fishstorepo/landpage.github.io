	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="../logo/adminfs.png" /></a>
			</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								...
								$itemId = $item = $cat = $scat = $brd = $bgImg = $image = $size = $clr = $detail = $matcar = $price = $disc = $stock = $available = "";
								...
								if (isset($_POST['save'])) {
									...
									if (!$error) {
										...
										if (mysqli_num_rows($query) > 0) {
											...
											// $qry = "INSERT INTO items VALUES ('$itemId','$item','$cat','$brd','$size','$clr','$bgImg','$filename','$detail','$matcar','$price','$disc','$stock','$available','$regdate')";

											// $qry = "INSERT INTO `items` (`item_id`, `item_name`, `cat_id`, `scat_id`, `brd_id`, `size`, `clr_id`, `bgimg`, `image`, `detail`, `material_care`, `price`, `discount`, `stock`, `available`, `creation_date`) 
											// VALUES ('$itemid', '$item', '$scat', '$cat', '$brd', '$size', '$clr', '$bgImgNew', '$filename', '$detail', '$matcar', '$price', '$disc', '$stock', '$available', '$regdate')";

											// // $qry = "INSERT INTO items (item, cat, brd, size, clr, bgImg, filename, detail, matcar, price, disc, stock, available, regdate) 
											// // VALUES ('$item', '$cat', '$brd', '$size', '$clr', '$bgImg', '$filename', '$detail', '$matcar', '$price', '$disc', '$stock', '$available', '$regdate')";

											// // $qry = "INSERT INTO items (product_name, category, brand, size, color, background_img, filename, detail, material_care, price, discount, stock, available, registration_date) 
											// // VALUES ('$item', '$cat', '$brd', '$size', '$clr', '$bgImg', '$filename', '$detail', '$matcar', '$price', '$disc', '$stock', '$available', '$regdate')";

											// // $qry = "INSERT INTO items (item, cat, brd, size, clr, bgImg, image, filename, detail, matcar, price, disc, stock, available, regdate) 
											// // VALUES ('$item', '$cat', '$brd', '$size', '$clr', '$bgImg', $image, '$filename', '$detail', '$matcar', '$price', '$disc', '$stock', '$available', '$regdate')";
											...
											$qry = "INSERT INTO `items` (`item_id`, `item_name`, `cat_id`, `scat_id`, `brd_id`, `size`, `clr_id`, `bgimg`, `image`, `detail`, `material_care`, `price`, `discount`, `stock`, `available`, `creation_date`) 
													VALUES ('$itemId', '$item',  '$cat','$scat', '$brd', '$size', '$clr', '$bgImgNew', '$filename', '$detail', '$matcar', '$price', '$disc', '$stock', '$available', '$regdate')";

											mysqli_query($conn, $qry);
											echo "Error: Category, subcategory, or brand values are empty or invalid.";
											header('location: product.php');
										}
									}
								}
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											$checkbox_elements = array(
												"S" => array('allsize' => 'Small'), "M" => array('allsize' => 'Medium'), "L" => array('allsize' => 'Large'), "XL" => array('allsize' => 'Xtra Large'), "XXL" => array('allsize' => 'Xtra-xtra Large'),
