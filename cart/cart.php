<div class="shopping">
	<div class="container">
		...
		<table class="timetable_sub">
			...
			?>
					<tr>
						...
						<td align="center"><?php echo $values['qty']; ?> Kg</td>
						...
						<td align="center"><a href="../index.php?p=cart&item=<?php echo $values['product_id']; ?>&sz=<?php echo $values['size']; ?>"><i class="fa fa-times-circle-o"></i></a></td>
					</tr>
			<?php
				}
			}
		...
		if (isset($_GET['item'])) {
			foreach ($_SESSION["cart"] as $keys => $values) {
				if ($values['product_id'] && $values['size'] == $_GET['sz']) {
