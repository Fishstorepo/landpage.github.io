		...
		<div class="col-lg-12">
			...
			<div class="col-md-8 single-right">
				<form action="../index.php?p=single&id=<?php echo $_GET['id']; ?>" method="POST">
					...
					<p class="availability">Status Stok: <?php echo $data['available']; ?></span></p>
					...
					if ($error) {
						...
						if (isset($_SESSION['cart'])) {
							...
							foreach ($_SESSION["cart"] as $keys => $values) {
								if ($_SESSION['cart'][$keys]['product_id'] == $_GET['id'] && $_SESSION['cart'][$keys]['size'] == $_POST['size-item']) {
									$is_available++;
