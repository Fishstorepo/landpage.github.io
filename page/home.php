		...
		<div class="core-slider_viewport">
			<div class="core-slider_list">
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 2.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 3.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 4.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 1.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 6.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 12.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 8.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 11.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 9.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 10.png" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/bg/Rectangle 13.png" alt="">
				</div>
			</div>
		</div>
...
<div class="container-fluid brands"><!-- <div class="container-fluid hidden-xs"> -->
	<div class="row">
		<div class="col-md-12 text-center">
			<h2 class="text-center text1">Shop by Brand</h2>
		</div>
